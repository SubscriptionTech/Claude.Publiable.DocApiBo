...
1. **Pull the latest version of the API Backoffice specs** — Update the `shared/ProAbonoBO` submodule to the latest remote commit.
...
### Action 1 — Pull the latest version of the API Backoffice specs
